...
-- =============================================================================
-- Digital health identity for mobile populations in Eastern & Southern Africa
...
('11111111-1111-1111-1111-111111111101', 'clinic_admin', 'Full clinic management', '["manage_clinic","manage_staff","register_patient","request_access","view_summary","add_prescription","view_audit","export_audit"]'),
('11111111-1111-1111-1111-111111111102', 'doctor', 'Primary care provider', '["register_patient","request_access","view_summary","add_prescription"]'),
